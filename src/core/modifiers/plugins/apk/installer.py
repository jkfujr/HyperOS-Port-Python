...
class InstallerModifier(ApkModifierPlugin):
    ...
    def _disable_install_risk_switches(self, work_dir: Path):
        ...
        for keyword in targets:
            self.smali_seek_and_replace(
                work_dir, keyword, return_value="const/4 v0, 0x0", return_type="Z"
            )
    ...
    def _disable_full_safe_version(self, work_dir: Path):
        ...
        self.smali_seek_and_replace(
            work_dir, "installer_full_safe_version", return_value="const/4 v0, 0x0", return_type="Z"
        )
    ...
    def _disable_upload_and_intercept(self, work_dir: Path):
        ...
        # AVL Upload
        self.smali_patch(
            work_dir, seek_keyword="appSourcepackageName", remake=".locals 0\n    return-void"
        )
        ...
        self.smali_patch(work_dir, seek_keyword=sig, remake=".locals 0\n    return-void")
    ...
    def _remove_network_error_ui(self, work_dir: Path):
        ...
        layout_ids = ["layout_network_error", "safe_mode_layout_network_error"]
